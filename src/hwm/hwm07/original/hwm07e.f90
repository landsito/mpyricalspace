!  Horizontal Wind Model HWM07 (HWM071308E, D. P. Drob, NRL, 13 Jul 2008)
!  Adapted for mpyricalspace from the NRL release: in subroutine HWMupdate the
!  pointer-aliased `target` dummy arrays ebz/ebm (non-conforming F95, rejected by
!  modern gfortran) are indexed directly -- ebz(c,b) in place of the bz(c) alias.
!  The model logic is unchanged.  Original: git history.
!
!
