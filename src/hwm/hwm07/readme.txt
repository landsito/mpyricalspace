...
VERSION HISTORY
  ...
  13 JUL 08 HWM071308E_DWM07B104i (Release version)
  06 APR 09 HWM071308E_DWM07B104i.01 (This version)


PACKAGE CONTENTS
  readme.txt          This file
  checkhwm07.f90      Test driver and test output data
  hwm07.01.f90        Source code for evaluating HWM07 and DWM07
...
RELEASE NOTES
      This version is an update only of the code used to evaluate the model; 
  the model parameters are the same as the original release version.
  ...
  dwm07b_104i.dat, and gd2qd.dat. These file should be located in the 
  directory from which the program is run. Alternatively, the data paths can be 
  specified explicitly via the subroutines LOADHWMQT, LOADDWM, and LOADGD2QD.
