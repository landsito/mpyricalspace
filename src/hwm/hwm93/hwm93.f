C  Horizontal Wind Model HWM93  (A. E. Hedin, 1/25/93)
C  Adapted for mpyricalspace from the NRL release:
C    - non-Fortran email header and test-driver/output text removed
C    - character literals in INTEGER DATA (ISDATE/ISTIME/NAME) -> 4H Hollerith
C  The model code (GWS5 and helpers) is otherwise unchanged.  Original: git history.
C-----------------------------------------------------------------------
*************************************************************************
...
C          HWM93    28-JAN-93   
     ...
     $PBU1(50),PBU2(50),PCU1(50),PCU2(50)
      ...
      DATA ISDATE/4H28-J,4HAN-9,4H3   /,ISTIME/4H20:3,4H5:39/
      DATA NAME/4HHWM9,4H3   /
C         WINF
      DATA PBA1/
