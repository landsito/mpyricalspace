...

{
  ...
  param_plot[EEJ_IDX_LUNAR] = w->params.plot_lunar;
  ...
  param_max[EEJ_IDX_LUNAR] = 24.0 + 5.0 / 6.0;
...

{
  ...
  eej_plot_params.plot_season = 266.0;
  eej_plot_params.plot_euvac = 100.0;
  eej_plot_params.plot_lunar = 12.4;
  ...
  while ((c = getopt(argc, argv, "l:t:s:e:m:p:o:hy:")) != (-1))
  {
    switch (c)
    {
      ...
      case 'm':
        eej_plot_params.plot_lunar = strtod(optarg, NULL);
        break;
          ...
          switch (*optarg)
            {
              ...
              case 'm':
                eej_plot_params.plot_idx = EEJ_IDX_LUNAR;
                break;
      ...
      default:
        ...
        printf("  -m <lunar time> : Specifies value of lunar local time in lunar hours [default: %f]\n",
               eej_plot_params.plot_lunar);
