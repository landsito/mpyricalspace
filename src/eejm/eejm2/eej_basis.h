...
/* dimension of fit function (phi, t, s, euvac, tau) */
#define EEJ_FIT_DIM                  5

extern size_t n_eejm_np;
extern size_t n_eejm_nt;
extern size_t n_eejm_ns;
extern size_t n_eejm_ne;
extern size_t n_eejm_nl;

/* number of terms in each sum of mean fit functions */

#define EEJ_MEAN_FIT_N_PHI_CHAMP     9
#define EEJ_MEAN_FIT_N_T_CHAMP       7
#define EEJ_MEAN_FIT_N_S_CHAMP       5
#define EEJ_MEAN_FIT_N_EUVAC_CHAMP   2
#define EEJ_MEAN_FIT_N_LUNAR_CHAMP   3

#define EEJ_MEAN_FIT_N_PHI_OER       9
#define EEJ_MEAN_FIT_N_T_OER         4
#define EEJ_MEAN_FIT_N_S_OER         5
#define EEJ_MEAN_FIT_N_EUVAC_OER     2
#define EEJ_MEAN_FIT_N_LUNAR_OER     3

#define EEJ_MEAN_FIT_N_PHI_SAC       9
#define EEJ_MEAN_FIT_N_T_SAC         1
#define EEJ_MEAN_FIT_N_S_SAC         5
#define EEJ_MEAN_FIT_N_EUVAC_SAC     2
#define EEJ_MEAN_FIT_N_LUNAR_SAC     3

/* number of terms in each sum of stddev fit functions */

#define EEJ_STDDEV_FIT_N_PHI_CHAMP   3
#define EEJ_STDDEV_FIT_N_T_CHAMP     7
#define EEJ_STDDEV_FIT_N_S_CHAMP     7
#define EEJ_STDDEV_FIT_N_EUVAC_CHAMP 2
#define EEJ_STDDEV_FIT_N_LUNAR_CHAMP 3

#define EEJ_STDDEV_FIT_N_PHI_OER     3
#define EEJ_STDDEV_FIT_N_T_OER       7
#define EEJ_STDDEV_FIT_N_S_OER       7
#define EEJ_STDDEV_FIT_N_EUVAC_OER   2
#define EEJ_STDDEV_FIT_N_LUNAR_OER   3

#define EEJ_STDDEV_FIT_N_PHI_SAC     9
#define EEJ_STDDEV_FIT_N_T_SAC       1
#define EEJ_STDDEV_FIT_N_S_SAC       7
#define EEJ_STDDEV_FIT_N_EUVAC_SAC   2
#define EEJ_STDDEV_FIT_N_LUNAR_SAC   3
...
int eej_basis_lunar(double phi, double y[], void *params);
